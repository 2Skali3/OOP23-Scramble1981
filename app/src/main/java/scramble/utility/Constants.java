...
public class Constants {
    ...
    /** Movement speed on the Y axis of the bomb bullet type. Used in model/bullets/Bullet. */
    public static final int YSPEED_BOMB = 5;
    /** Movement speed on the X axis of the bomb bullet type. Used in model/bullets/Bullet. */
    ...
    //view
    /** Number of stars generated in the background. Used in view/compact/BackgroundPanel. */
    public static final int NUMBER_OF_STAR_IN_BACKGROUND = 100;
    /** Scales up the fuel bar for a fitting image on the screen. Used in view/compact/FuelBarPanel. */

...
public final class LandscapeDataLoads {
    ...
    public static PairImpl<
        ...
        List<PairImpl<Integer, LandscapeBehaviour>>> getPrestageData() {
        return new PairImpl<List<PairImpl<Integer, LandscapeBehaviour>>, List<PairImpl<Integer, LandscapeBehaviour>>>(
                CSV_READER.readCSV(PRESTAGE_CEILING), CSV_READER.readCSV(PRESTAGE_FLOOR));
    }
    ...
    public static PairImpl<
        List<PairImpl<Integer, LandscapeBehaviour>>, 
        List<PairImpl<Integer, LandscapeBehaviour>>> getStage1Data() {
        return new PairImpl<List<PairImpl<Integer, LandscapeBehaviour>>, List<PairImpl<Integer, LandscapeBehaviour>>>(
                CSV_READER.readCSV(STAGE_1_CEILING_FILE_PATH), CSV_READER.readCSV(STAGE_1_FLOOR_FILE_PATH));
    }
    ...
    public static PairImpl<
        List<PairImpl<Integer, LandscapeBehaviour>>, 
        List<PairImpl<Integer, LandscapeBehaviour>>> getStage2Data() {
        return new PairImpl<List<PairImpl<Integer, LandscapeBehaviour>>, List<PairImpl<Integer, LandscapeBehaviour>>>(
                CSV_READER.readCSV(STAGE_2_CEILING_FILE_PATH), CSV_READER.readCSV(STAGE_2_FLOOR_FILE_PATH));
    }
    ...
    public static PairImpl<
        List<PairImpl<Integer, LandscapeBehaviour>>, 
        List<PairImpl<Integer, LandscapeBehaviour>>> getStage3Data() {
        return new PairImpl<List<PairImpl<Integer, LandscapeBehaviour>>, List<PairImpl<Integer, LandscapeBehaviour>>>(
                CSV_READER.readCSV(STAGE_3_CEILING_FILE_PATH), CSV_READER.readCSV(STAGE_3_FLOOR_FILE_PATH));
    }
    ...
    public static PairImpl<
        List<PairImpl<Integer, LandscapeBehaviour>>, 
        List<PairImpl<Integer, LandscapeBehaviour>>> getStage4Data() {
        return new PairImpl<List<PairImpl<Integer, LandscapeBehaviour>>, List<PairImpl<Integer, LandscapeBehaviour>>>(
                CSV_READER.readCSV(STAGE_4_CEILING_FILE_PATH), CSV_READER.readCSV(STAGE_4_FLOOR_FILE_PATH));
    }
    ...
    public static PairImpl<
        List<PairImpl<Integer, LandscapeBehaviour>>, 
        List<PairImpl<Integer, LandscapeBehaviour>>> getStage5Data() {
        return new PairImpl<List<PairImpl<Integer, LandscapeBehaviour>>, List<PairImpl<Integer, LandscapeBehaviour>>>(
                CSV_READER.readCSV(STAGE_5_CEILING_FILE_PATH), CSV_READER.readCSV(STAGE_5_FLOOR_FILE_PATH));
    }
    ...
    public static PairImpl<
        List<PairImpl<Integer, LandscapeBehaviour>>, 
        List<PairImpl<Integer, LandscapeBehaviour>>> getStage6Data() {
        return new PairImpl<List<PairImpl<Integer, LandscapeBehaviour>>, List<PairImpl<Integer, LandscapeBehaviour>>>(
                CSV_READER.readCSV(STAGE_6_CEILING_FILE_PATH), CSV_READER.readCSV(STAGE_6_FLOOR_FILE_PATH));
    }
}

...
/**
 * TimedLinkedList interface defines the contract for a timed list where elements are automatically
...
public interface TimedLinkedList<T> {
    /**
     * Adds an element to the list and schedules its removal after the specified time.
     *
     * @param element the element to be added
     * @param time    the time in milliseconds after which the element will be removed
     * @return {@code true} if the element was successfully added to the list
     */
    boolean addElement(T element, long time);

    /**
     * Adds all elements from the specified collection to the list, and schedules each of them
